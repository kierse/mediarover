...
from mediarover.source.newzbin.episode import NewzbinSingleEpisode, NewzbinDailyEpisode, NewzbinMultiEpisode
from mediarover.utils.injection import is_instance_of, Dependency

class SabnzbdFactory(EpisodeFactory):
	...
	def create_episode(self, string, **kwargs):
		...
		# add job id to list of parameters
		params['id'] = job_id
		...
		if 'start_episode' in params:
			return SabnzbdMultiEpisode(**params)
		elif 'year' in params:
			return SabnzbdDailyEpisode(**params)
		else:
			return SabnzbdSingleEpisode(**params)
